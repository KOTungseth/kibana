...
Drag the data fields you want to visualize to the workspace, and the visualization editor uses best practices to apply the fields and create a visualization that best displays your data. 

[float]
[[find-your-lens-data]]
=== Find your data
Tell Kibana where to find the data you want to visualize, then specify the time range.

. Open the main menu, then select *Dashboard*.

. Open or create the dashboard. 
...
For details, check <<data-views, Create a data view.>>

. Specify the <<set-time-filter,time range>>.
+
...
=== Visualize the fields in your data
If you already know the visualization you want to use, select the visualization. If you're unsure about the visualization type you want to use, 
drag the fields you want to visualize onto the workspace, then let the editor choose for you. 

. Open the *Visualization type* dropdown, then select the visualization you want to use.  
...
Metric visualizations display single values, and allow you to customize the color, value format, icon, and more.

. From the *Visualization type* dropdown, select *Metric*. 
...
* *Value format* &mdash; Specifies how the field value displays in the metric. 

* *Color mode* &mdash; Specifies how color is applied.

* *Icon decoration* &mdash; Specific the icon to display.

* *Supporting visualization* &mdash; Specifies the visualization type to display in the metric.
...
To create partition charts with multiple metrics, use the layer settings. Multiple metrics are unsupported in mosaic visualizations.
