...
The best way to create visualization panels is with the drag-and-drop visualization editor, which allows you to drag fields to the workspace, then automatically creates a visualization
that best displays your data. 

The drag-and-drop visualization editor supports the following panel types, features, functions, and aggregations.
