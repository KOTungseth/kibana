...
=======
++++
<titleabbrev>Dashboard &mdash; view and analyze data</titleabbrev>
++++
...
present and share. On a dashboard, you can add a variety of panels that you can rearrange to build a 
...
Panels contain everythng you need to tell a story about you data, including visualizations, 
>>>>>>> 99b56fdc915... [DOCS] Dashboard-first refresh
interactive controls, Markdown, and more.
...
=======
To create a panel, make sure you have {ref}/getting-started-index.html[data indexed into {es}] and an <<index-patterns,index pattern>> 
to retrieve the data from {es}.

If you aren’t ready to use your own data, {kib} comes with several pre-built dashboards that you can test out. For more information, 
refer to <<add-sample-data, Explore {kib} using sample data>>.

{kib} provides you with several options to create panels. To begin, click *Create new*, then choose one of the following options on the 
*New Visualization* window:
...
To add the data you want to visualize:
...
=======
* <<vega-lite-tutorial-create-your-first-visualizations,Vega-Lite tutorial: Create your first visualization>>
* <<vega-tutorial-update-kibana-filters-from-vega,Vega tutorial: Update Kibana filters>>
>>>>>>> 99b56fdc915... [DOCS] Dashboard-first refresh
...
== Save panels
=======
* <<timelion-tutorial-create-time-series-visualizations,Timelion tutorial: Create time series visualizations>>
* <<timelion-tutorial-create-visualizations-with-mathematical-functions,Timelion tutorial: Create visualizations with mathematical functions>>
* <<timelion-tutorial-create-visualizations-withconditional-logic-and-tracking-trends,Timelion tutorial: Create visualizations with conditional logic and tracking trends>>
...
=======
To make changes to the panel, put the dashboard in *Edit* mode, then select *Edit visualization* or *Edit panel title* from the panel menu. 
The changes you make appear in every dashboard that uses the panel.
>>>>>>> 99b56fdc915... [DOCS] Dashboard-first refresh
