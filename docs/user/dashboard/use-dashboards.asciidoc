...
filter to display the data want to you see. When the panels on a dashboard contain a saved query, and the dashboard contains a saved query, both queries are applied.
